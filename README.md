...
## 📈 Example pH Signal Plot

![pH Signal Plot](analysis/ph_plot.png)

This plot was generated by exporting the real-time Rust sensor stream to `data.csv` and visualizing it using a small Python script with **Pandas** and **Matplotlib**. The goal was to inspect how noise behaves over time and verify that our filtering logic correctly stabilizes the signal without hiding meaningful changes.
